  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 px-8 pb-8">
        <Card>
          <div className="border-b border-border px-5 py-3 text-sm font-medium">Top events</div>
            ...
            <ul className="divide-y divide-border">
              {eventCounts.map((row) => (
                <li key={row.name} className="flex items-center justify-between px-5 py-3 text-sm">
                  ...
                  <span className="text-muted">{row._count.name}</span>
                </li>
              ))}
            </ul>
          )}
        ...
        <Card>
          <div className="border-b border-border px-5 py-3 text-sm font-medium">Recent activity</div>
