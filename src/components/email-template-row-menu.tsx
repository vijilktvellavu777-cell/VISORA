...
export function EmailTemplateRowMenu({ templateId, templateName }: Props) {
  ...
  async function handleCopy() {
    setBusy(true);
    setOpen(false);
    const response = await fetch(`/api/templates/${templateId}/copy`, { method: "POST" });
    setBusy(false);
  ...
  function handleEdit() {
    setOpen(false);
    router.push(`/content/templates/email/${templateId}/edit`);
  }
