...
export function LinkTableLinkRowMenu({ linkTableId, linkId, linkName, linkUrl }: Props) {
  ...
  async function handleCopy() {
    setBusy(true);
    setOpen(false);
    await fetch(`/api/content/link-table/${linkTableId}/links`, {
      method: "POST",
  ...
  async function handleDelete() {
    ...
    setBusy(true);
    const response = await fetch(`/api/content/link-table/${linkTableId}/links/${linkId}`, {
      method: "DELETE",
    });
    setBusy(false);
